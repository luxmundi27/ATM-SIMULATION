# ATM-SIMULATION
Using my python knowledge to mimic the operation of an ATM machine
...
* **User Authentication:** Validating users via a secure PIN system.
...
* **Environment:** Any standard IDE (VS Code, PyCharm) or Terminal.
* **Version Control:** [Git & GitHub](https://github.com/luxmundi27/ATM-SIMULATION)

### **Core Programming Skills**

* **Logic Control:** Use of `if-elif-else` statements and `while` loops for continuous operation.
* **Data Handling:** Managing user data through variables, lists, or dictionaries.
...
* **Cash Deposit:** Update account totals with new deposits.
...
```bash
git clone https://github.com/luxmundi27/ATM-SIMULATION.git
